...
signal_balance:
  ...
  evolving: 13
description: |
  How AI transforms knowledge work. Why the next 3 years will reshape
  how expertise is created, validated, and delivered.
key_claims:
...
1. **Invest in AI fluency now** — The learning curve is your moat
2. **Rethink how you measure productivity** — Output per person will vary 10x based on AI leverage
3. **Focus on judgment and relationships** — AI handles the work, humans handle the trust
4. **Prepare for consolidation** — AI-native organizations will outcompete laggards
